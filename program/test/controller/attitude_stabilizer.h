...
void PID_attitude_yaw(attitude_stablizer_pid_t* ,imu_data_t* ,attitude_t* );void PID_attitude_rc_pass_command(attitude_stablizer_pid_t* ,attitude_stablizer_pid_t* ,attitude_stablizer_pid_t* ,radio_controller_t* );
#endif